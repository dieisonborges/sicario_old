      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            ...
            <a href="#" class="small-box-footer">Novo Ticket <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->  
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            ...
            <a href="#" class="small-box-footer">Novo Livro <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
